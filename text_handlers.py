...
def sort_results(results, keyphrase):
    ...
    above_the_threshold_results = [result for result in results if result[1] > loader.threshold_1]
...
def get_answer_data(keyphrase):
    ...
    db_list_keyphrases = [item.get('keyphrase') for item in loader.db_list_keyphrases]
